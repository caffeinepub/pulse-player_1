...
import type { CloudData as _CloudData, PlaylistData as _PlaylistData, Track as _Track, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addTrackToPlaylist(arg0: string, arg1: Track): Promise<void> {
        if (this.processError) {
            try {
    ...
    async exportCloudData(): Promise<CloudData> {
        if (this.processError) {
            try {
                const result = await this.actor.exportCloudData();
                return from_candid_CloudData_n3(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async getAllPlaylists(): Promise<Array<string>> {
        if (this.processError) {
            try {
    ...
    async getPlaylist(arg0: string): Promise<Array<Track> | null> {
        if (this.processError) {
            try {
    ...
    async renamePlaylist(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async toggleFavorite(arg0: string): Promise<void> {
        if (this.processError) {
            try {
...
function from_candid_CloudData_n3(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _CloudData): CloudData {
...
function from_candid_opt_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [Array<_Track>]): Array<Track> | null {
...
function from_candid_record_n4(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    playlists: Array<[string, _PlaylistData]>;
    favorites: Array<string>;
    history: Array<string>;
